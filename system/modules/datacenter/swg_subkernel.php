...
----------------------------------------------------------------------------
$Id: swg_subkernel.php,v 1.2 2009/02/14 18:46:11 s4u Exp $
#echo(sWGdatacenterVersion)#
sWG/#echo(__FILEPATH__)#
----------------------------------------------------------------------------
NOTE_END //n*/
/**
* Subkernel for: datacenter
*
...
if (!defined ("CLASS_direct_subkernel_datacenter"))
{
//c// direct_subkernel_datacenter
/**
* Subkernel for: datacenter
*
* @author     direct Netware Group
...
*             GNU General Public License 2
*/
class direct_subkernel_datacenter extends direct_virtual_class
{
/* -------------------------------------------------------------------------
Extend the class
------------------------------------------------------------------------- */

	//f// direct_subkernel_datacenter->__construct ()
/**
	* Constructor (PHP5) __construct (direct_subkernel_datacenter)
	*
	* @uses  direct_debug()
...
*/
	...
	{
		if (USE_debug_reporting) { direct_debug (5,"sWG/#echo(__FILEPATH__)# -kernel_class->__construct (direct_subkernel_datacenter)- (#echo(__LINE__)#)"); }
...
------------------------------------------------------------------------- */
	...
	//f// direct_subkernel_datacenter->subkernel_init ($f_threshold_id = "")
/**
	...
	public function subkernel_init ($f_threshold_id = "")
	{
		...
		if (empty ($f_return))
		{
			if ($direct_classes['db']->v_connect ())
			{
				...
				if (!$direct_classes['basic_functions']->settings_get ($direct_settings['path_data']."/settings/swg_datacenter.php")) { $f_return = array ("core_required_object_not_found","FATAL ERROR:<br />&quot;$direct_settings[path_data]/settings/swg_datacenter.php&quot; was not found<br /><br />sWG/#echo(__FILEPATH__)# -kernel_class->subkernel_init ()- (#echo(__LINE__)#)"); }
			}
...
$direct_classes['@names']['subkernel_datacenter'] = "direct_subkernel_datacenter";
define ("CLASS_direct_subkernel_datacenter",true);

//j// Script specific commands

direct_class_init ("subkernel_datacenter");
$direct_classes['kernel']->v_call_set ("v_subkernel_init",$direct_classes['subkernel_datacenter'],"subkernel_init");
}
